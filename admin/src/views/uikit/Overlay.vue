  ...
  methods: {
    ...
    submitForm() {
      console.log('Submit button clicked');
        ...
        const url = `http://localhost:8000/proyecto/create/?fecha_inicio=${formattedStartDate}&fecha_fin=${formattedEndDate}&prioridad=${this.formData.prioridad}&folio_solicitud=${this.formData.folio_solicitud}&jsonwebtoken=${this.authToken}`;
