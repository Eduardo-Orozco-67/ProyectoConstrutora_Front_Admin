  ...
  methods: {
    ...
    submitFormSupervisor() {
      ...
      if (this.validateFields()) {
        axios.post(`https://api-constructora.onrender.com/supervisor/create/?jsonwebtoken=${this.authToken}`, this.supervisorFormData)
          .then(response => {
    ...
    submitFormColaborador() {
      ...
      if (this.validateFieldsColaborador()) {
        ...
        axios.post(`https://api-constructora.onrender.com/colaborador/create/?telefono_supervisor=${this.colaboradorFormData.telefono_supervisor}&jsonwebtoken=${this.authToken}`, this.colaboradorFormData)
        .then(response => {
        if (response.status === 200) {
