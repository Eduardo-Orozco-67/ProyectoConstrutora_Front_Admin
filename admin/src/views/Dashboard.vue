...
try {
  const response = await axios.get(`http://localhost:8000/solicitud_proyecto/ver-todas?jsonwebtoken=${authToken.value}`);
...
try {
  const response = await axios.get(`http://localhost:8000/reportes/proyectos-50/?jsonwebtoken=${authToken.value}`);
...
try {
  const response = await axios.get(`http://localhost:8000/reportes/proyectos-aceptados/?jsonwebtoken=${authToken.value}`);
...
try {
  const response = await axios.get(`http://localhost:8000/reportes/proyectos-prioridad/?jsonwebtoken=${authToken.value}`);
...
try {
  const response = await axios.patch(`http://localhost:8000/solicitud_proyecto/actualizar-estado/${folioSolicitud}?estado=${estado}&jsonwebtoken=${authToken.value}`);
